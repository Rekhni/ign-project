...
const GeosparkPage = ({ lang }) => {
  ...
  return (
        <div className="text-dark bg-white h-100" style={{ fontFamily: "Montserrat" }}>
            {/* HERO */}
            <div className="geospark-hero">
                {/* Background image (iPhone-safe) */}
                <img src={geosparkBgImg} alt="" className="geospark-hero__bg" />

                {/* Dark overlay */}
                <div className="geospark-hero__overlay" />

                {/* Content */}
                <div className="geospark-hero__content">
                <div className="geospark-hero__text">
                ...
                <img className="geospark-logo" src={geosparkLogo} alt="geospark-logo" />
                </div>
            </div>
