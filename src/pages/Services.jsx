...
export default function Services({ lang }) {
    ...
    return (
        <div className='w-100 bg-white text-dark' style={{fontFamily: 'Montserrat', paddingBottom: '100px'}}>
          <div
          ...
          >
            ...
            <div class="accordion w-75 mx-auto" style={{backgroundColor: 'rgb(68, 98, 112)'}} id="accordionPanelsStayOpenExample">
